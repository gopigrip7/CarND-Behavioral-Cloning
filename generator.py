...
class Generator:
    ...
    def preprocessImage(self,image):
        ...
        image = cv2.resize(image,(self.new_size_col,self.new_size_row),interpolation=cv2.INTER_AREA)    
        #image = image/255.-.5
        return image
    ...
    def preprocess_image_file_train(self,line_data):
        ...
        if (i_lrc == 2):
            ...
            shift_ang = -.25
        y_steer = float(line_data['steering'][0]) + shift_ang
        path_file = "{}/{}".format(self.image_fdir,path_file)
